	...
	<div id="poststuff">
		...
		<div id="post-body" class="metabox-holder columns-2">
            ...
            <input name="sml_remove" value="1" type="hidden" />
									...
									if (count($lines)) {
										...
										foreach ($lines as $data) {
											...
											if (is_email(trim($data[0]))) {
												...
												if (!is_array($c)) {											
													$wpdb->query("INSERT INTO ".$wpdb->prefix."sml (sml_email) VALUES ('".$wpdb->escape(trim($data[0]))."')");
													$correct++;
												} else { $exists++; }
											} else { $invalid++; }
										}
                ...
                <p class="description">File must contain list of email address.</p>
                <p>Example: joe@blogs.com</p>
