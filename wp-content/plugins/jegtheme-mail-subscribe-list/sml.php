<?php
/*
Plugin Name: Jegtheme Mail Subscribe List
Plugin URI: http://jegtheme.com
Description: Simple customisable plugin that displays a name/email form where visitors can submit their information, managable in the WordPress admin. Modified to meet Jegtheme Requirement
Version: 1.0.1
...
function sml_subscribe_widget_control($args=array(), $params=array()) {
	...
	Show Submit Button:
	<input class="widefat" id="sml_subscribe_widget_showsubmit" name="sml_subscribe_widget_showsubmit" type="checkbox" value="1"
	<?php echo $sml_subscribe_widget_showsubmit ? 'checked="checked"' : ''; ?>>
	<br /><br />
