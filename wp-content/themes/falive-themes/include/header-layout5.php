<?php
    $logo   = apply_filters('jeg_logo_5', vp_option('joption.logo', get_template_directory_uri() .'/images/logo.png'));
    $logo2x = apply_filters('jeg_logo_5_retina', vp_option('joption.logo_retina', get_template_directory_uri() .'/images/logo@2x.png'));
        ...
        <div class="top-wrapper">
            <div class="container">
                ...
                <div class="iklan-wrapper">
                    ...
                    <?php else: ?>
                        <?php echo jeg_generate_google_ads(); ?>
                    <?php endif; ?>
                </div>
            </div>
        </div>
