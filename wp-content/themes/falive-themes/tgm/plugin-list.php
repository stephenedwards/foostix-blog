...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'     				=> 'Falive Plugin',
            'slug'     				=> 'falive-plugin',
            'source'   				=> get_stylesheet_directory() . '/plugin/falive-plugin.zip',
            'required' 				=> true,
            'version' 				=> '1.0.1',
        ...
        array(
            'name'     				=> 'Jegtheme Subscriber',
            'slug'     				=> 'jegtheme-mail-subscribe-list',
            'source'   				=> get_stylesheet_directory() . '/plugin/jegtheme-mail-subscribe-list.zip',
            'required' 				=> true,
            'version' 				=> '1.0.1',
            'force_activation' 		=> false,
            'force_deactivation' 	=> false,
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/plugin/vafpress-post-formats-ui-develop.zip',
            'required'              => true,
            'version'               => '1.5',
            'force_activation'      => false,
            'force_deactivation'    => false,
